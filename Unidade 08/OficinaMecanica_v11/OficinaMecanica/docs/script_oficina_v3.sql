...
-- alteracao coluna DECSRICAO para DESCRICAO
ALTER TABLE item RENAME COLUMN decsricao TO descricao;

-- alteracao coluna OS_ITENSCOL para VALOR
ALTER TABLE os_item RENAME COLUMN os_itenscol TO valor;
